    ...
    <div class="registeForm" :class="show ? 'showRegister' : ''">
        ...
        <div class="form">
            ...
            <div class="inputbox">
                ...
                <el-input v-model="name" placeholder="昵称" />
            </div>
            <div class="inputbox">
                <svg t="1659662793314" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="3254" width="24" height="24">
                ...
                <el-input v-model="idCard"  placeholder="请输入身份证号" maxlength="18" />
            </div>
        </div>
...
import { user_registe } from './registehttp'
...
const register = () => {
    if (username.value && password.value && phone.value && name.value && idCard.value) {
        user_registe({username:username.value,password:password.value,phone:phone.value,name:name.value,idCard:idCard.value})
        ElMessage({
            type: 'success',
            message: '注册成功！'
        })

        ...
        <div class="searchHeader"> 
            ...
            <div class="train">
                <div class="citybetween">
                    <div class="startcity"> 
                        <input type="text" id="start" placeholder="出发城市">
                        <label for="start" >
                            出发城市
                        </label>                    
                    </div>
